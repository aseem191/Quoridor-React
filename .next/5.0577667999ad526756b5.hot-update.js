...
var _this = this,
    _jsxFileName = "C:\\Users\\Aseem\\React Projects\\ReactQuoridor\\pages\\game.js";
...
window.addEventListener("beforeunload", function (ev) {
  ...
  if (_this.props.gameID) {
    var params = {
      id: _this.props.gameID
    };
    __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/destroy/" + tempID, {
      method: 'DELETE',
      headers: {
...
function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this2 = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, props));
    _this2.fetchGame = _this2.fetchGame.bind(_assertThisInitialized(_this2));
    _this2.brickMouseOver = _this2.brickMouseOver.bind(_assertThisInitialized(_this2));
    _this2.brickMouseLeave = _this2.brickMouseLeave.bind(_assertThisInitialized(_this2));
    _this2.clickBrick = _this2.clickBrick.bind(_assertThisInitialized(_this2));
    _this2.squareMouseOver = _this2.squareMouseOver.bind(_assertThisInitialized(_this2));
    _this2.squareMouseLeave = _this2.squareMouseLeave.bind(_assertThisInitialized(_this2));
    _this2.clickSquare = _this2.clickSquare.bind(_assertThisInitialized(_this2));
    ...
    var params = {
      uname: _this2.props.name
    };

    if (!_this2.props.gameID) {
      __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/player", {
        ...
        if (!data.error) {
          __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + data.id).then(function (response) {
            ...
            _this2.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions_js__["b" /* updateGameID */])(data._id));
  ...
  _createClass(Game, [{
    ...
    value: function fetchGame() {
      ...
      if (this.props.gameID) {
        __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + this.props.gameID).then(function (response) {
          ...
          _this3.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions_js__["a" /* updateGame */])(data));

          var x1 = _this3.props.game.Player1x;
          var y1 = _this3.props.game.Player1y;
          var x2 = _this3.props.game.Player2x;
          var y2 = _this3.props.game.Player2y;

          if (data.ToDestroy) {
            var tempID = _this3.props.gameID;

            _this3.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions_js__["b" /* updateGameID */])(null));

            _this3.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_6__redux_actions_js__["a" /* updateGame */])(null));

            console.log("ending game" + _this3.props.gameID);
          ...
          for (var i = 0; i < data.Player1Bricks.length; i++) {
            if (data.Player1Bricks[i].vertical) {
              var temparr = _this3.state.verticalBricks.slice();

              temparr[data.Player1Bricks[i].x][data.Player1Bricks[i].y] = _this3.state.brickExistsColor;

              _this3.setState({
                verticalBricks: temparr
              });
            } else {
              var temparr = _this3.state.horizontalBricks.slice();
          ...
          for (var i = 0; i < data.Player2Bricks.length; i++) {
            if (data.Player2Bricks[i].vertical) {
              ...
              temparr[data.Player2Bricks[i].x][data.Player2Bricks[i].y] = _this3.state.brickExistsColor;
          ...
          var temparr = _this3.state.playerArray.slice();

          temparr[x1][y1] = _this3.state.squareColor;
          temparr[x2][y2] = _this3.state.squareColor;
          temparr[data.Player1x][data.Player1y] = _this3.state.player1Color;
          temparr[data.Player2x][data.Player2y] = _this3.state.player2Color;
    ...
    value: function render() {
      ...
      }, "Error: ", this.state.errorMsg), this.props.game.Player2 ? this.props.game.PlayerTurn == 1 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 655
        }
      ...
      }, "It's ", this.props.game.Player1, "'s turn! "), " ") : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 656
        }
...
//# sourceMappingURL=5.0577667999ad526756b5.hot-update.js.map