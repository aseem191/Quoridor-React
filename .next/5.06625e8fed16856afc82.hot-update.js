      ...
      if (this.props.game) {
        if (playing == this.props.name) {
          if (playing == this.props.game.Player1) {
            console.log(this.props.game.Player1x + " " + event.currentTarget.getAttribute('x') + " " + this.props.game.Player1y + " " + event.currentTarget.getAttribute('y'));
...
//# sourceMappingURL=5.06625e8fed16856afc82.hot-update.js.map