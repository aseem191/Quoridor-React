    ...
    value: function fetchGame() {
      ...
      if (this.props.gameID) {
        __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + this.props.gameID).then(function (response) {
          ...
          temparr[_this2.props.game.Player1x][_this2.props.game.Player1y] = _this2.state.squareColor;
          temparr[_this2.props.game.Player2x][_this2.props.game.Player2y] = _this2.state.squareColor;
          console.log(temparr[_this2.props.game.Player2x][_this2.props.game.Player2y] + "p2c");
...
//# sourceMappingURL=5.08333f66cc691b116a18.hot-update.js.map