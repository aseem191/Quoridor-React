        ...
        __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + this.props.gameID).then(function (response) {
          ...
          for (var i = 0; i < data.Player1Bricks.length; i++) {
            if (data.Player1Bricks[i].vertical) {
              ...
              temparr[data.Player1Bricks[i].x][data.Player1Bricks[i].x] = _this2.state.brickExistsColor;
              ...
              temparr[event.currentTarget.getAttribute('x')][event.currentTarget.getAttribute('y')] = _this2.state.brickExistsColor;
...
//# sourceMappingURL=5.37b45267fd1b319a774f.hot-update.js.map