    ...
    value: function fetchGame() {
      ...
      if (this.props.gameID) {
        __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + this.props.gameID).then(function (response) {
          ...
          var temparr = _this2.state.playerArray.slice(); //temparr[this.props.game.Player1x][this.props.game.Player1y] = this.state.squareColor;
          //temparr[this.props.game.Player2x][this.props.game.Player2y] = this.state.squareColor;
...
//# sourceMappingURL=5.5cc2af3f24b3a65c3c0e.hot-update.js.map