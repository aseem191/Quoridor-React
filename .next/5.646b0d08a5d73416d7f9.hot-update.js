      ...
      if (this.props.game) {
        if (playing == this.props.name) {
          if (playing == this.props.game.Player1) {
            console.log(this.props.game.Player1x + " " + event.currentTarget.getAttribute('x') + " " + this.props.game.Player2y + " " + event.currentTarget.getAttribute('y'));
...
//# sourceMappingURL=5.646b0d08a5d73416d7f9.hot-update.js.map