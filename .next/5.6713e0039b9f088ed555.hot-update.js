...
function (_React$Component) {
  ...
  function Game(props) {
    ...
    }).then(function (data) {}).then(function (id) {
      return __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + id).then(function (response) {
        return response.json();
      }).then(function (data) {
  ...
  _createClass(Game, [{
    ...
    value: function render() {
      ...
      }, this.props.game ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 25
        }
...
//# sourceMappingURL=5.6713e0039b9f088ed555.hot-update.js.map