...
/*window.addEventListener("beforeunload", (ev) => 
{
	...
	if(gameID){
		...
		fetch(urlname + "/destroy", {method: 'DELETE', headers: { 'Content-Type': 'application/json'}, body: JSON.stringify(params)}).then(response => response.json()).then(data => {
...
//# sourceMappingURL=5.a8bed31e42b1599c6703.hot-update.js.map