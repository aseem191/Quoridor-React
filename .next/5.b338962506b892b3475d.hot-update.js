  ...
  _createClass(Game, [{
    ...
    value: function fetchGame() {
      if (this.props.gameID) {
        __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + this.props.gameID, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
...
//# sourceMappingURL=5.b338962506b892b3475d.hot-update.js.map