      ...
      if (this.props.gameID) {
        __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + this.props.gameID).then(function (response) {
          ...
          if (data.Player1y == 8 || data.Player2y == 0) {
            ...
            __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + _this2.props.gameID, {
              method: 'DELETE',
              headers: {
                'Content-Type': 'application/json'
              },
...
//# sourceMappingURL=5.be40724b87b956165fd4.hot-update.js.map