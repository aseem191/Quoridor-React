...
function (_React$Component) {
  ...
  function Game(props) {
    ...
    __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/player", {
      ...
      __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_3__components_urlname_js__["a" /* default */] + "/game/" + id).then(function (response) {
        return response.json();
      }).then(function (data) {
...
//# sourceMappingURL=5.c56f88aca5767d695ee9.hot-update.js.map